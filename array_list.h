...
#ifndef ARRAY_LIST_H
#define ARRAY_LIST_H
#define ARRAY_LIST_CONCAT_(a, b) ARRAY_LIST_CONCAT_1(a, b)
#define ARRAY_LIST_CONCAT_1(a, b) a ## b
#endif

#define ARRAY_LIST_INIT ARRAY_LIST_CONCAT_(ARRAY_LIST, _Init)
#define ARRAY_LIST_RESIZE ARRAY_LIST_CONCAT_(ARRAY_LIST, _Resize)
#define ARRAY_LIST_APPEND ARRAY_LIST_CONCAT_(ARRAY_LIST, _Append)
#define ARRAY_LIST_APPEND_N_TIMES ARRAY_LIST_CONCAT_(ARRAY_LIST, _Append_N_Times)
#define ARRAY_LIST_APPEND_BUFFER ARRAY_LIST_CONCAT_(ARRAY_LIST, _Append_Buffer)
#define ARRAY_LIST_APPEND_BUFFER_N_TIMES ARRAY_LIST_CONCAT_(ARRAY_LIST, _Append_Buffer_N_Times)
#define ARRAY_LIST_POP ARRAY_LIST_CONCAT_(ARRAY_LIST, _Pop)
#define ARRAY_LIST_SWAP_REMOVE ARRAY_LIST_CONCAT_(ARRAY_LIST, _Swap_Remove)
#define ARRAY_LIST_SWAP_REMOVE_U ARRAY_LIST_CONCAT_(ARRAY_LIST, _Swap_Remove_U)
#define ARRAY_LIST_ORDERED_REMOVE ARRAY_LIST_CONCAT_(ARRAY_LIST, _Ordered_Remove)
#define ARRAY_LIST_ORDERED_REMOVE_U ARRAY_LIST_CONCAT_(ARRAY_LIST, _Ordered_Remove_U)
#define ARRAY_LIST_CLONE ARRAY_LIST_CONCAT_(ARRAY_LIST, _Clone)
#define ARRAY_LIST_DEINIT_U ARRAY_LIST_CONCAT_(ARRAY_LIST, _Deinit_U)
#define ARRAY_LIST_DEINIT ARRAY_LIST_CONCAT_(ARRAY_LIST, _Deinit)
